...
mod test {
    ...
    async fn t40_attendance_no_options() {
        ...
        assert_eq!(
            found,
            "{\"type\":4,\"data\":{\"embeds\":[{\"title\":\"Attendance through week 16\",\"type\":\"rich\",\"description\":\"<@695398918694895710>\\nRanks in the top quarter, outstanding attendance!\\n🤩\",\"fields\":[{\"name\":\"Weekly attendance\",\"value\":\"Attended 10 of 16 weeks\",\"inline\":false},{\"name\":\"Game attendance\",\"value\":\"Attended 30 games\",\"inline\":false}]}],\"flags\":64}}"
        );
    }
    ...
    async fn t40_attendance_manager() {
        ...
        assert_eq!(
            found,
            "{\"type\":4,\"data\":{\"embeds\":[{\"title\":\"Attendance through week 16\",\"type\":\"rich\",\"description\":\"<@1050119194533961860>\\nRanks in the top quarter, outstanding attendance!\\n🤩\",\"fields\":[{\"name\":\"Weekly attendance\",\"value\":\"Attended 7 of 16 weeks\",\"inline\":false},{\"name\":\"Game attendance\",\"value\":\"Attended 14 games\",\"inline\":false}]}]}}"
        );
    }
